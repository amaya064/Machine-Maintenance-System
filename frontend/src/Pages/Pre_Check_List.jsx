...
export default function Pre_Check_List() {
  const [employees, setEmployees] = useState([
    { id: 1, epf: 'EPF001', name: 'John Doe', team: 'Development', status: null },
    { id: 2, epf: 'EPF002', name: 'Jane Smith', team: 'Design', status: null },
    { id: 3, epf: 'EPF003', name: 'Mike Johnson', team: 'QA', status: null },
    { id: 4, epf: 'EPF004', name: 'Sarah Wilson', team: 'Development', status: null },
    { id: 5, epf: 'EPF005', name: 'David Brown', team: 'Operations', status: null },
  ]);
